...
(define-method wiliki:format-page-header ((fmt <blog-formatter>) page . opts)
  ...
  (cond-list
   ...
   [#t `(header (@ (role "banner"))
         (button (@ (type "button") (id "menu_button") (class "drawer-toggle drawer-hamburger") (style "display: none;"))
...
(define-method wiliki:format-page-footer ((fmt <blog-formatter>) page . opts)
  `((footer
         ...
         (a (@ ;;(xmlns:cc "http://creativecommons.org/ns#")
               (href "https://misskey.osyakasyama.me/@pleasure666")
    ...
    `((main (@ (role "main"))
       (div (@ (class "content-table"))
         (div (@ (class "content-row"))
           (div (@ (class "content-cell menu-strip"))
                 (div ,@(wiliki:search-box))
                 ,@(wiliki:get-formatted-page-content "_SidePane"))
           (div (@ (class "content-cell main-pane"))
               (div (@ (class "content"))
                    ,@(cond-list
